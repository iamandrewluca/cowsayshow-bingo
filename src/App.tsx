...
// prettier-ignore
const items = [
	{ checked: false, text: `AI ne lasă fără de lucru` },
	{ checked: false, text: `Apare un nou clon la twitter` },
	{ checked: false, text: `Right to repair` },
	{ checked: false, text: `Cineva îmbracă (metaforic) o beretă din folie de aluminiu` },
	{ checked: false, text: `Spunem cuvintele Elon și Anime într-o propoziție` },
	{ checked: false, text: `Ceva nu de bine despre Rust 😱` },
	{ checked: false, text: `Vlad spune cuvântul "speculativ"` },
	{ checked: false, text: `Ceva cu gaming nu de bine` },
	{ checked: false, text: `Vanea face o glumă la care nimeni nu râde` },
	{ checked: false, text: `Am uitat să spunem că "Văcuța vă iubește"` },
	{ checked: false, text: `Epizod fără cuvântul "layoffs"` },
	{ checked: false, text: `Moldovenii fac un app inutil` },
	{ checked: false, text: `Cowsay: Cineva a zis Mu in microfon` },
	{ checked: false, text: `Glumă despre Voronin` },
	{ checked: false, text: `Lăudăm JavaScript (Sau un nou npm framework)` },
	{ checked: false, text: `Menționăm Mastodon moldovenesc` },
	{ checked: false, text: `Câine în eter` },
	{ checked: false, text: `Tiktok în judecată` },
	{ checked: false, text: `Moldovenii fac un app util` },
	{ checked: false, text: `Vorbim despre ML fara să menționăm Python` },
	{ checked: false, text: `Vorbim despre legislație timp de 5 minute` },
	{ checked: false, text: `Spunem ceva bine despre Bitcoin` },
	{ checked: false, text: `Cowsay evită să spună numele lui Elon` },
	{ checked: false, text: `AI ne aduce la comunism` },
	{ checked: false, text: `Spunem cuvintele Elon și Anime într-o propoziție` },
];
