...
const items = [
	`AI ne lasă fără de lucru`,
	`Apare un nou clon la twitter`,
	`Right to repair`,
	`Cineva îmbracă (metaforic) o beretă din folie de aluminiu`,
	`Spunem cuvintele Elon și Anime într-o propoziție`,
	`Ceva nu de bine despre Rust 😱`,
	`Vlad spune cuvântul "speculativ"`,
	`Ceva cu gaming nu de bine`,
	`Vanea face o glumă la care nimeni nu râde`,
	`Am uitat să spunem că "Văcuța vă iubește"`,
	`Epizod fără cuvântul "layoffs"`,
	`Moldovenii fac un app inutil`,
	`Cowsay: Cineva a zis Mu in microfon`,
	`Glumă despre Voronin`,
	`Lăudăm JavaScript (Sau un nou npm framework)`,
	`Menționăm Mastodon moldovenesc`,
	`Câine în eter`,
	`Tiktok în judecată`,
	`Moldovenii fac un app util`,
	`Vorbim despre ML fara să menționăm Python`,
	`Vorbim despre legislație timp de 5 minute`,
	`Spunem ceva bine despre Bitcoin`,
	`Cowsay evită să spună numele lui Elon`,
	`AI ne aduce la comunism`,
	`Spunem cuvintele Elon și Anime într-o propoziție`,
